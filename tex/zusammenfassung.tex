...
Bei diesen Punkten handelt es sich ausdrücklich um den subjektiven Versuch des Autors, Reaktionen aufzuzeigen die durch das dokumentierte Führungsverhalten (siehe Abschnitt: \nameref{subsec:ablauf_situation}) entstehen können.
...
Wie der Abschnitt \nameref{sec:moegl_reaktionen} aufzeigt liegen mögliche (interpretierten) Defizite in der Wertschätzung der \ac{MA}, welche durch diverse Ansätze gelöst werden könnten. 
